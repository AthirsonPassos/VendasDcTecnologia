...
<head>
    ...
    <title>Projeto: Vendas Parceladas - DcTecnologia</title>
    ...
    <link rel="mask-icon" href="{{ asset('icones/msafari-pinned-tab.svg') }}" color="#712cf9">
...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Projeto: Vendas Parceladas -
            DcTecnologia</a>
